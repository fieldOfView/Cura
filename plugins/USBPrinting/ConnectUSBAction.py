...
class ConnectUSBAction(MachineAction):
    def __init__(self, parent = None):
        ...
        self._usbDeviceManager = None
        Application.getInstance().engineCreatedSignal.connect(self._onEngineCreated)

    def _onEngineCreated(self) -> None:
        self._usbDeviceManager = USBPrinterOutputDeviceManager.USBPrinterOutputDeviceManager.getInstance()
        self._usbDeviceManager.serialPortsChanged.connect(self.serialPortsChanged)
    ...
    def portList(self):
        return self._usbDeviceManager.portList()


    @pyqtSlot(bool)
    def setListAllSerialPorts(self, list_all_serial_ports):
        self._usbDeviceManager.setListAllSerialPorts(list_all_serial_ports)